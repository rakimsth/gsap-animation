...
.from('.writing', 1, {x: 900, opacity: 0, ease: Power1.easeInOut}, "rectangleB+=1.0")
...
.to('.education', 1, {x: -600, opacity: 1, ease: Power1.easeInOut}, "animationOut")
.to('.writing', 1, {x: 600, opacity: 1, ease: Power1.easeInOut}, "animationWritingOut")
.to('.writingabtedu', 1, {y:600, opacity: 1, ease: Power1.easeInOut}, "animationAbtOut")
.to('.eduTextDesc', 1, {x: -600, opacity: 1, ease: Power1.easeInOut}, "animationOut")
.to('.writingTextDesc', 1, {x: 600, opacity: 1, ease: Power1.easeInOut}, "animationWritingOut")
.to('.writingAbtTextDesc', 1, {y:600, opacity: 1, ease: Power1.easeInOut}, "animationAbtOut")
